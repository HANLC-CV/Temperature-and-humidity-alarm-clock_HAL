...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DS_CLK_Pin|DS_RST_Pin|NVD_SDA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, DS_IO_Pin|NVD_CLK_Pin|VCC_P00_Pin|VCC_P01_Pin
                          |VCC_P02_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : DS_CLK_Pin DS_RST_Pin NVD_CLK_Pin NVD_SDA_Pin
                           VCC_P00_Pin VCC_P01_Pin VCC_P02_Pin */
  ...
  /*Configure GPIO pins : MIC_IN_Pin TORCH_Pin */
  GPIO_InitStruct.Pin = MIC_IN_Pin|TORCH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
